	...
	<body class="hold-transition register-page">
		...
		<div class="register-box" style="width: 800px;margin-top:0;margin-bottom:0;">
			...
			<div class="register-box-body" >
				...
				<h2 class="page-header" style="text-align: center;"><sp:message code="com.reguser"/></h2>
				<div class="row">
					<div class="col-md-12">
						<!-- 用户注册 -->
						<div class="tab-pane active" id="tab_1">
							<form class="form-horizontal"  id="jksFrom" action="<%=path%>/com/add" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="radio" class="form-control" name="companyType" checked="checked" value="1"><sp:message code="com.gly"/>
										<input type="radio" class="form-control" name="companyType" value="7"><sp:message code="com.yh"/>
									</div>
								</div>
								<div class="form-group">
