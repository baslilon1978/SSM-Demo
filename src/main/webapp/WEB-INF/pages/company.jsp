							...
							<form id="queryForm" action="<%=path%>/com/list" method="post">
								<div class="col-xs-1">
									<select id="area" name="type" class="form-control input-sm">
										...
										<option value="4" hidden="hidden" disabled="disabled"><sp:message code="com.jks"/></option>
										<option value="5" hidden="hidden" disabled="disabled"><sp:message code="com.dls"/></option>
										<option value="2" hidden="hidden" disabled="disabled"><sp:message code="com.scs"/></option>
										<option value="3" hidden="hidden" disabled="disabled"><sp:message code="com.cks"/></option>
										<option value="6" hidden="hidden" disabled="disabled"><sp:message code="com.jxs"/></option>
										<option value="1"><sp:message code="com.gly"/></option>
										<option value="7"><sp:message code="com.yh"/></option>
									</select>
								</div>
								<div class="col-xs-2">
